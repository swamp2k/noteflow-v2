...
export async function notesHandler(request, env, ctx, url, path, method, userId, origin) {
  ...
  if (path === "/api/notes" && method === "POST") {
    ...
    const taskFlag=is_task?1:0; const dueVal=due_date||null; const prioVal=(priority!=null&&priority!=='')?String(priority):null;
